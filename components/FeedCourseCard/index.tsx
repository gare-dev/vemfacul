...
export const FeedCourseCard = ({
    ...
    return (
        <div className={styles.courseApprovalCard} onClick={(e) => { router.push(`/cursinho/${course.id_cursinho}`); e.stopPropagation(); }} role="button" tabIndex={0} onKeyPress={() => { router.push(`/cursinho/${course.id_cursinho}`); }}>
            ...
            <div className={styles.courseInfo}>
                <div className={styles.nomeLoc}>
                    ...
                    <div className={styles.locationInfo}>
                        ...
                        <p className={styles.district}>{course.uf + ", " + course.cidade}</p> {/* Adicionando o distrito */}
                    </div>
                </div>
